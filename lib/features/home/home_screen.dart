...
class _HomeScreenState extends ConsumerState<HomeScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _screenController = AnimationController(duration: const Duration(milliseconds: 400), vsync: this, value: 0);
    _fadeAnimation = CurvedAnimation(parent: _screenController, curve: Curves.easeInOut);
